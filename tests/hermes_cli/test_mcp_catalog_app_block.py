...
@pytest.mark.parametrize("extra, message", [
    ...
    ("app: { linux: { presence: executable, location: /x/y, version: { kind: plist } } }", "only valid under app.darwin"),
    ("app: { win32: { presence: executable, location: 'C:/x/y.exe', version: { kind: uninstall_registry } } }", "display_name_prefix"),
