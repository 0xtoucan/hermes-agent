...
export const ar = defineLocale({
  ...
  settings: {
    ...
    vault: {
      ...
      count: n => `${n} محفوظة`,
      matchCount: (shown, total) => `${shown} من ${total}`,
      searchPlaceholder: 'ابحث حسب التسمية أو المعرّف أو الموقع',
      searchLabel: 'البحث في العناصر المحفوظة',
      kindFilterAll: 'الكل',
      noMatches: 'لا توجد عناصر مطابقة',
      noMatchesDesc: 'جرّب بحثًا مختلفًا أو امسح عوامل التصفية.',
      clearFilters: 'مسح عوامل التصفية',
