...
export const ar = defineLocale({
  ...
  skills: {
    plugins: {
      consentLabel: 'الأذونات',
      consentPending: 'مطلوبة',
      consentAllowed: 'مسموح بها',
      consentPendingHint: 'طلبت هذه الإضافة الأذونات التالية. إلى أن تسمح بها ستعمل بالأذونات الافتراضية فقط، وسيُحظر أي شيء تحاوله خارجها.',
      consentAllowedHint: 'سمحت بهذه الأذونات لهذا الملف الشخصي. الإلغاء يعيد الإضافة إلى الأذونات الافتراضية.',
      consentAllow: 'سماح',
      consentRevoke: 'إلغاء',
      consentAllowedToast: (name: string) => `يمكن لـ ${name} الآن استخدام الأذونات التي طلبتها.`,
      consentRevokedToast: (name: string) => `عادت ${name} إلى الأذونات الافتراضية.`,
      consentRequestTitle: (name: string) => `${name} تطلب أذونات`,
      consentRequestMessage: (count: number) => `طلبت ${count} من الأذونات خارج الافتراضية. ستعمل بدونها إلى أن تسمح بها في «القدرات › الإضافات».`,
      consentReview: 'مراجعة',
      sandboxBlockedTitle: (name: string) => `تم حظر الإضافة «${name}»`,
      sandboxBlockedPending: (action: string, method: string) => `حاولت ${action} («${method}») ولم تسمح بذلك بعد. راجع أذوناتها في «القدرات › الإضافات».`,
      sandboxBlockedUndeclared: (action: string, method: string, capability: string) => `حاولت ${action} («${method}») بدون قدرة «${capability}». يجب أن تعلن الإضافة عنها ضمن desktop_capabilities في ملف plugin.yaml.`,
      sandboxDisabledTitle: (name: string) => `تم تعطيل الإضافة «${name}»`,
      capabilityLabels: {
        ui: 'إضافة واجهة وعرض تنبيهات',
        storage: 'حفظ إعداداتها الخاصة',
        events: 'متابعة أحداث البوابة',
        rest: 'التواصل مع خلفيتها الخاصة',
        restAny: 'استدعاء أي مسار خلفي',
        gatewayRequest: 'قراءة الجلسات والمهارات والحالة',
        promptSubmit: 'إرسال المطالبات باسمك',
        llm: 'تشغيل طلبات النموذج',
        composer: 'قراءة مسودتك وتعديلها',
        navigate: 'التنقل داخل التطبيق',
        osClipboard: 'الكتابة إلى الحافظة',
        osDialogs: 'فتح مربعات حوار الملفات',
        osOpenExternal: 'فتح الروابط في متصفحك',
        osRevealPath: 'إظهار ملفاتها في مدير الملفات',
        osNotify: 'إرسال إشعارات النظام'
      }
    },
    tabSkills: 'المهارات',
